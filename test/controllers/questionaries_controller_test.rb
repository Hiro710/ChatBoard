...
class QuestionariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create questionary" do
    assert_difference('Questionary.count') do
      post questionaries_url, params: { questionary: { deadline: @questionary.deadline, description: @questionary.description } }
    end
  ...
  test "should update questionary" do
    patch questionary_url(@questionary), params: { questionary: { deadline: @questionary.deadline, description: @questionary.description } }

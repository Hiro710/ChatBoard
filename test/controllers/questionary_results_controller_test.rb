...
class QuestionaryResultsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create questionary_result" do
    assert_difference('QuestionaryResult.count') do
      post questionary_results_url, params: { questionary_result: { questionary_item: @questionary_result.questionary_item, result: @questionary_result.result } }
    end
  ...
  test "should update questionary_result" do
    patch questionary_result_url(@questionary_result), params: { questionary_result: { questionary_item: @questionary_result.questionary_item, result: @questionary_result.result } }
